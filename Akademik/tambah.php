	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			if(mysqli_num_rows($cek) == 0){
				$sql = mysqli_query($koneksi, "INSERT INTO mahasiswa(nim, nama_mhs, jk, id_jurusan) VALUES('$nim', '$nama_mhs', '$jk', '$id_jurusan')") or die(mysqli_error($koneksi));
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select name="id_jurusan" class="form-control" required>
						...
						<option value="KEDOCTERAN">KEDOCTERAN</option>
					</select>
				</div>
			</div>
			<div class="form-group row">
